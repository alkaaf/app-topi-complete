...
{
    // default connection
    public static $dbname = 'bakupsiak'; // Your database name
    ...
    // theme and language
    public static $theme = 'spm'; // can be 'default', 'bootstrap', 'minimal' or your custom. Theme of xCRUD visual presentation. For using bootstrap you need to load it on your page.
    ...
    // editor
    public static $editor_url = false;
    ...
    public static $can_minimize = true; // allows 'minimize' arrow in grid
    ...
    public static $column_cut = 500; // Sets the maximum number of characters in the column.
    ...
    public static $upload_folder_def = FCPATH; // Default uploads folder on your site, relative to xCRUD folder or absolute path required. Folder is must exist.
    ...
    public static $php_date_format = 'd F Y'; // php date format
    ...
    // external session
    public static $external_session = true;
    // loading events 
    public static $before_construct = 'xcrud_restore_session'; // callable param, runs before instance creation
    public static $after_render = 'xcrud_store_session'; // use only when you use integration with externall session
