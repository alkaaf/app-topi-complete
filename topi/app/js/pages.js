...
(function($, window, document){
  ...
  $(function(){
    ...
    // to bspanel-heading. Used in page login-multi.
    var Selector           = '[data-toggle="collapse-autoactive"]',
        bspanelHeading       = '.bspanel-heading',
        bspanelHeadingActive = 'bspanel-heading-active';
    
      $(document).on('show.bs.collapse', Selector, function (e) {
        // From the bspanel-group, deactive all headings
        $(e.currentTarget)
          .find(bspanelHeading)
          .removeClass(bspanelHeadingActive);
        // And activate the target heading
        $(e.target)
          .siblings(bspanelHeading)
          .addClass(bspanelHeadingActive);
      });
